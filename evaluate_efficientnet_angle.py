...
MODEL_PATH = "best_efficientnet_angle.pth"
TEST_CSV = "test_angle.csv"
...
test_data = test_data[test_data['angle'].isin(LABELS)].reset_index(drop=True)
print(f"Filtered test data size (top/side only): {len(test_data)}")
...
for idx, row in test_data.iterrows():
    ...
    try:
        ...
        with torch.no_grad():
            ...
            actual_idx = 0 if actual_label == 'top' else 1
